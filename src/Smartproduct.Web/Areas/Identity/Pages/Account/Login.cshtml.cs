...
namespace Smartproduct.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<ExternalUser> signInManager,
            ...
            IConfiguration configuration, IHttpClientFactory factory, UserManager<ExternalUser> userManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return Redirect(Url.Action("Currentcategories", "Category"));
            }
